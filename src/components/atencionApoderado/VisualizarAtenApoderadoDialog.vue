...
<template>
  <Dialog
    ...
    <div class="card-border " style="margin-top: 1rem; margin-bottom: 1rem;">
      ...
      <p   v-if="tabla?.data?.length === 0"  class="text-center my-4 text-gray-500" style="margin-top: 1rem;">
    ...
    :style="{ width: '60rem' }">
      <template #header >
        <div class="flex align-items-center  justify-content-center" style="display: flex; align-items: center;">
            ...
            <span class=" font-semibold text-blue-600 dark:text-blue-700" style="font-size: 1.1rem;margin-left: .5rem;" >Detalle de Atencion - {{ props.nombre }}</span>
        </div>
      </template>
      <!-- Información Fecha -->
       <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 text-sm rounded-md px-4 py-2">
        ...
        <span class="font-bold text-blue-700 dark:text-blue-100" style="margin-left: .5rem;">{{ fecha }}</span>
      </div>
